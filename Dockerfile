...
RUN R -q -e 'BiocManager::install(c("shinythemes", "data.table",  "RCurl", "DT", "shinyjs", "shiny", "stringdist", "irr", "limma", "pbapply", "parallelDist", "mgcv", "psych", "RColorBrewer", "dplyr", "devtools", "ROR", "xlsx", "igraph", "ips", "XVector"))'
