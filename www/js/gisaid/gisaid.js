var gisaid = gisaid || (function () {
	...
	var generateAckLinkFromAccessionId = function(accessionId) {
		...
		let accessionIdLength = accessionIdNumber.length;
		
		return "https://www.epicov.org/acknowledgement/" + accessionIdNumber.charAt(accessionIdLength-4) + accessionIdNumber.charAt(accessionIdLength-3) + "/" + accessionIdNumber.charAt(accessionIdLength-2) + accessionIdNumber.charAt(accessionIdLength-1) + "/" + accessionId + ".json"
	}
